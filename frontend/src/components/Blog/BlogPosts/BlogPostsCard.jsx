...
const BlogPostsCard = ({Image, Category, Title, Description, Slug, AutorAvatar, AutorName, Date}) => {
  return (
    <Link
        to={`/blog/${Slug}`}
        className="bg-zinc-50 dark:bg-[#0d0d0f] group hover:-translate-y-0.5 hover:border-neutral-700 transition-all duration-200 ease-in-out w-full sm:h-56 border border-neutral-800 rounded-xl flex flex-col sm:flex-row overflow-hidden shadow-xl">
