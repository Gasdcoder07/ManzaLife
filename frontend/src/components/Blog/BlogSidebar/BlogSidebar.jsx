...
const BlogSidebar = () => {
  ...
  return (
    <aside className={`bg-[#fcfcfc] transition-all shadow-xl shadow-black/40 dark:bg-[#0d0d0f] relative hidden sm:flex sm:flex-col sm:justify-between border-r border-neutral-800/20 dark:border-neutral-800 ${isOpen ? 'w-56' : 'w-16'}`}>
        <div className="absolute z-20 top-4 right-0 translate-x-1/2 border border-neutral-800/20 dark:border-neutral-800 rounded-full p-1 bg-[#fcfcfc] dark:bg-[#0d0d0f] text-zinc-950 dark:text-white">
            <IoMenu
