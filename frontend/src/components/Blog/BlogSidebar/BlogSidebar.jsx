...
const BlogSidebar = () => {
  ...
  return (
    <aside className={`bg-[#fcfcfc] shadow-xl shadow-black/40 dark:bg-[#0d0d0f] relative hidden sm:flex sm:flex-col sm:justify-between border-r border-neutral-800/20 dark:border-neutral-800 ${isOpen ? 'w-56' : 'w-16'}`}>
