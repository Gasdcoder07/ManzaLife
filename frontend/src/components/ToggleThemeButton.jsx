...
const ToggleThemeButton = ({ isUsedInNavbar = false, isManzadle = false, isBlog}) => {
    ...
    >
        {isDark ? <IoSunny size={24} /> : <IoMoon size={24} className={isManzadle || isBlog ? 'text-orange-600 dark:text-white' : 'text-white'}/>}
    </button>
  )
}
