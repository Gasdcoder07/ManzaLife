...
const ToggleThemeButton = ({ isUsedInNavbar = false, isManzadle = true}) => {
    ...
    >
        {isDark ? <IoSunny size={24} /> : <IoMoon size={24} className={isManzadle ? 'text-orange-600 dark:text-white' : 'text-white'}/>}
    </button>
  )
}
