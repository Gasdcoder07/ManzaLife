...
const EditRequestModal = ({ isEnglish, setRequest, setShowModal, requestId, requestDescription, requestType }) => {
    ...
    const [requestTypeVisual, setRequestTypeVisual] = useState(RequestTypes.find(r => r.value === requestType)?.visual);
        ...
        <ModalLayout>
            <div
                ...
                <div className="space-y-2">
                    <h2 className="text-center tracking-wider italic text-zinc-950 dark:text-white">
                        {isEnglish ? 'Edit request' : 'Editar solicitud'}
                    </h2>
